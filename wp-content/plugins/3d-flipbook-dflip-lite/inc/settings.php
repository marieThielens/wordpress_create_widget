...
class DFlip_Settings
{
  ...
  public function settings_page()
  {
    ...
    <h2><?php echo esc_html( get_admin_page_title() ); ?> <a href="https://codecanyon.net/item/dflip-flipbook-wordpress-plugin/16408847?ref=deip" target="_blank">Buy Full Version</a></h2>
  ...
  public function updated_settings()
  {
    ?>
    <div class="error">
      <p><?php _e( 'Settings can be saved only in Premium Version updated.', 'DFLIP' ); ?> <a href="https://codecanyon.net/item/dflip-flipbook-wordpress-plugin/16408847?ref=deip" target="_blank">Buy Full Version</a></p>
    </div>
    <?php
