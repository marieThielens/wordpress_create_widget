...
class DFlip_Meta_boxes
{
  ...
  public function add_meta_boxes()
  {
    ...
    add_meta_box( 'dflip_post_meta_box_video', __( 'Video Tutorial', 'DFLIP' ), array( $this, 'create_meta_boxes_video' ), 'dflip', 'side', 'high' );
  ...
  public function create_meta_boxes_limit( $post )
  {
    ...
    <div class="dflip-notice lite-limits">
      <ol>
        <li> Demo Flipbooks will be limited to 10 pages,</li>
  ...
  public function save_meta_boxes( $post_id, $post )
  {
    ...
    if ( isset( $post->post_type ) && 'dflip' == $post->post_type ) {
      if ( empty( $settings['title'] ) ) {
        $settings['title'] = sanitize_title( $post->post_title );
      }
